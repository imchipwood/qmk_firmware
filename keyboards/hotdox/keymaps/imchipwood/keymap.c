...
#define KC_CTLF5    TD(CTL_F5)
#define KC_ALTF7    TD(ALT_F7)
...
//    |-------+-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------+-------|
        LSHIFT, Z,      X,      C,      V,      B,      MOMD,                       MONB,   N,      M,      COMM,   DOT,    SLSH,   RTCAP,
//    `-------+-------+-------+-------+-------+---------------'                   `---------------+-------+-------+-------+-------+-------'
        LCTRL,  LALT,   LGUI,   LOME,   REND,                                                       UP,     DOWN,   LEFT,   RGHT,   PSCR,
//     `--------------------------------------'                                                   `--------------------------------------'
//                                                    ,---------------.   ,---------------.
                                                        DEL,    INS,        LCTL,   LALT,
//                                            ,-------+-------+-------|   |-------+-------+-------.
...
//                                                    Left hand                   Right hand
//    ,-------------------------------------------------------.                   ,-------------------------------------------------------.
        ___,    F1,     F2,     F3,     F4,     CTLF5,  ___,                        F12,    F6,     ALTF7,  F8,     F9,     F10,    F11,
//    |-------+-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------+-------|
...
//    |-------+-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------+-------|
        ___,    ___,    MS_U,   ___,    ___,    ___,    ___,                        ___,    ___,    ___,    ___,    ___,    ___,    ___,
//    |-------+-------+-------+-------+-------+-------+       |                   |       +-------+-------+-------+-------+-------+-------|
        ___,    MS_L,   MS_D,   MS_R,   ___,    ___,                                        ___,    ___,    ___,    ___,    ___,    ___,
//    |-------+-------+-------+-------+-------+-------+-------|                   |-------+-------+-------+-------+-------+-------+-------|
